...
dashboards and search (for example `ecosystem.parserator/dataset` or `ecosystem.nimbusGuardian/policy`). The canonical field
reference lives in [`docs/integrations/ECOSYSTEM_METADATA.md`](docs/integrations/ECOSYSTEM_METADATA.md).
