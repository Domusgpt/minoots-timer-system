import { z } from 'zod';
import { ActionExecutionResult, TimerInstance, CommandAction } from '../types';
...
export class AgentCommandExecutor {
  async execute(action: CommandAction, timer: TimerInstance): Promise<ActionExecutionResult> {
