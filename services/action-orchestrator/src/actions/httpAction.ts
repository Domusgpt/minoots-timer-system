...
import { z } from 'zod';
import { ActionExecutionResult, TimerInstance, WebhookAction } from '../types';
...
export class HttpActionExecutor {
  async execute(action: WebhookAction, timer: TimerInstance): Promise<ActionExecutionResult> {
